...
import { Mail, Lock, Check, AlertCircle, Loader2, ArrowRight, KeyRound } from 'lucide-react';
...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!email || !password) {
      setUiState((prev) => ({ ...prev, error: 'Please enter both email and password' }));
      return;
    }
    ...
    try {
      ...
      setUiState({
        loading: false,
        error: err || 'Authentication failed. Please verify credentials.',
        success: '',
      });
    }
  };
