          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-6">
              ...
              >
                ...
                <div className={`w-9 h-9 rounded-xl flex items-center justify-center shrink-0 border shadow-sm ${
                  m.role === 'user'
                    ...
                    : 'bg-indigo-50 border-indigo-200 dark:bg-indigo-950 dark:border-indigo-850 text-indigo-600 dark:text-indigo-400'
                }`}>
            ...
            {sendingMessage && (
              <div className="flex gap-4 max-w-[80%]">
                <div className="w-9 h-9 rounded-xl bg-indigo-50 dark:bg-indigo-950 border border-indigo-200 dark:border-indigo-850 text-indigo-600 dark:text-indigo-400 flex items-center justify-center shrink-0">
